...
Rectangle {
    ...
    property alias input_03: input_03
    ...
    transitions: [
        Transition {
            to: "fullView"
            NumberAnimation { target: input_03; property: "initialSliderValue"; to: slider.value}
            PropertyAnimation { target: input_03; property: "z"; to: 1}
            ...
            ParallelAnimation{
                ...
                NumberAnimation{ target: input_03; property: "x"; to: fullViewX; duration: enlargeTime}
                NumberAnimation { target: input_03; property: "y"; to: fullViewY; duration: enlargeTime}
                ...
                PropertyAnimation { target: input_03; property: "width"; to: fullViewWidth; duration: enlargeTime}
                PropertyAnimation { target: input_03; property: "height"; to: fullViewHeight; duration: enlargeTime;}
            }
        },
        Transition {
            to: "reducedView"
            ...
            ParallelAnimation{
                ...
                PropertyAnimation { target: input_03; property: "x"; to: initialX; duration: shrinkTime}
                PropertyAnimation { target: input_03; property: "y"; to: initialY; duration: shrinkTime}
                ...
                PropertyAnimation { target: input_03; property: "width"; to: initialWidth_reducedView; duration: shrinkTime}
                PropertyAnimation { target: input_03; property: "height"; to: initialheight_reducedView; duration: shrinkTime}
            ...
            PropertyAnimation { target: input_03; property: "z"; to: 0}
        }
    ]
    ...
    Component.onCompleted: {
        ...
        mainImageWith_reducedView = input_03.width * 0.4
        mainImageMargin_reducedView = input_03.width * 0.012

        magnitudeLabelFontSize_reducedView = input_03.width * 0.28 // 0.31
        magnitudeLabelFontSize2_reducedView = input_03.width * 0.15// 0.31
        magnitudeLabelWidth_reducedView = input_03.width * 0.95//0.92
        magnitudeLabelHeigtht_reducedView = input_03.width * 0.28
        magnitudeLabelX_reducedView = input_03.width * 0.03
        magnitudeLabelY_reducedView = input_03.width * 0.43

        unitsLabelFontSize_reducedView = input_03.width * 0.12
        unitsLabelWidth_reducedView = input_03.width * 0.4
        unitsLabelHeigtht_reducedView = input_03.width * 0.02
        unitsLabelX_reducedView = input_03.width * 0.54
        unitsLabelY_reducedView = input_03.width * 0.09
        unitsLabel2Y_reducedView = input_03.width * 0.25

        initialWidth_reducedView = input_03.width
        initialheight_reducedView = input_03.width * 0.72
        input_03.height = initialheight_reducedView
        input_03.state = startState
...
//      console.log("Completed: ")
    ...
    Rectangle {
        ...
        Button{
            ...
            opacity: 0
            anchors.fill: parent
            onClicked:{ input_03.state = "reducedView"; input_03.inspected = true; input_03.verificado(); }
        }
    }
    ...
    Rectangle {
        ...
        Button{
            ...
            onClicked: {
                ...
                input_03.state = "reducedView"
                input_03.inspected = true
                input_03.verificado()
            }
        }
    }
