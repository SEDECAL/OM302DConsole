...
//          PropertyAnimation { target: fullControlButton; property: "visible"; to: true}
    ...
    Component.onCompleted: {
        ...
        magnitudeLabelFontSize_reducedView = inputForm.width * 0.28 // 0.31
        magnitudeLabelFontSize2_reducedView = inputForm.width * 0.15// 0.31
        magnitudeLabelWidth_reducedView = inputForm.width * 0.95//0.92
