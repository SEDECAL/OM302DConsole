...
Rectangle {
    ...
    transitions: [
        Transition {
            ...
            SequentialAnimation{
                ...
                ParallelAnimation{
                    PropertyAnimation { target: input_02; property: "x"; to: fullViewX; duration: enlargeTime}
                    PropertyAnimation { target: input_02; property: "y"; to: fullViewY; duration: enlargeTime}
                    ...
                    PropertyAnimation { target: input_02; property: "width"; to: fullViewWidth; duration: enlargeTime}
                    PropertyAnimation { target: input_02; property: "height"; to: fullViewHeight; duration: enlargeTime}
                }
                ParallelAnimation{
        ...
        Transition {
            ...
            SequentialAnimation{
                ...
                ParallelAnimation{
                    PropertyAnimation { target: input_02; property: "x"; to: initialX; duration: enlargeTime}
                    PropertyAnimation { target: input_02; property: "y"; to: initialY; duration: enlargeTime}
                    ...
                    PropertyAnimation { target: input_02; property: "width"; to: initialWidth_reducedView; duration: shrinkTime}
                    PropertyAnimation { target: input_02; property: "height"; to: initialheight_reducedView; duration: shrinkTime}
                }
    ...
    property alias input_02: input_02
    ...
    Component.onCompleted: {
        ...
        mainImageWith_reducedView = input_02.width * 0.4
        mainImageMargin_reducedView = input_02.width * 0.012

        magnitudeLabelFontSize_reducedView = input_02.width * 0.28 // 0.31
        magnitudeLabelWidth_reducedView = input_02.width * 0.95//0.92
        magnitudeLabelHeigtht_reducedView = input_02.width * 0.28
        magnitudeLabelX_reducedView = input_02.width * 0.03
        magnitudeLabelY_reducedView = input_02.width * 0.43

        unitsLabelFontSize_reducedView = input_02.width * 0.12
        unitsLabelWidth_reducedView = input_02.width * 0.4
        unitsLabelHeigtht_reducedView = input_02.width * 0.02
        unitsLabelX_reducedView = input_02.width * 0.54
        unitsLabelY_reducedView = input_02.width * 0.09

        initialWidth_reducedView = input_02.width
        initialheight_reducedView = input_02.width * 0.72
        input_02.height = initialheight_reducedView

        console.log("fullViewWidth: ", input_02.fullViewWidth)
        console.log("fullViewHeight: ", input_02.fullViewHeight)
    }
    ...
    Rectangle {
        ...
        Button{
            opacity: 0
            anchors.fill: parent
            onClicked: input_02.state = "reducedView"
        }
    }
...
//          onClicked: input_02.state = "reducedView"
    ...
    Button{
        ...
        anchors.fill: parent
        opacity: 0
        onClicked: input_02.state = "fullView"
    }
