...
//                            Rename 'input_03' by inputForm
// Input_05.qml (20/03/2018): Progress_00 item evaluation here
// Input_06.qml (20/03/2018): Progress_00 item removed
//                            New fullView distribution
...
Rectangle {
    ...
    property int operationButtonWidth: fullViewWidth * 0.11//0.085
    property int operationButtonHeight: fullViewWidth * 0.11//0.085
    property int fixButtonWidth: fullViewWidth * 0.13//0.1
    property int fixButtonHeight: fullViewWidth * 0.070//0.055
    property int fixButtonMargin: fullViewWidth * 0.0285//0.025
    property int fixDownButtonMargin: fullViewWidth * 0.213
    property int externalBorderMargin: fullViewWidth * 0.03//0.02
    property int sliderSideMargins: externalBorderMargin //fullViewWidth * 0.035
    property int sliderDownMargin: fullViewWidth * 0.298
    property int sliderverticalCenterOffset: fullViewWidth * 0.018
    property int upDownButtonBottomMargin: fullViewWidth * 0.388//0.12
    property int saveButtonBottomMargin: fullViewWidth * 0.12
    property int buttonRadius: fullViewWidth * 0.008
    property int fixButtonFontSize: fullViewWidth * 0.04//0.03
    property int magnitudeTextSize: fullViewWidth * 0.16
    property int unitsTextSize: fullViewWidth * 0.03
    property int backgroundRadius: fullViewWidth * 0.003
    ...
    property int magnitudeLabelFontSize_fullView: fullViewWidth * 0.20//0.16
    property int magnitudeLabelFontSize2_fullView: fullViewWidth * 0.1//0.09
    property int magnitudeLabelWidth_fullView: fullViewWidth * 0.7//0.57
    property int magnitudeLabelHeigtht_fullView: fullViewWidth * 0.14//0.13
    property int magnitudeLabelX_fullView: fullViewWidth * 0.150//0.29
    property int magnitudeLabelY_fullView: fullViewWidth * 0.292//0.14
    property int magnitudeLabel2Y_fullView: fullViewWidth * 0.312

    property int unitsLabelFontSize_fullView: fullViewWidth * 0.09//0.05
    property int unitsLabelWidth_fullView: fullViewWidth * 0.32//0.241
    property int unitsLabelHeigtht_fullView: fullViewWidth * 0.103//0.078
    property int unitsLabelX_fullView: fullViewWidth * 0.65//0.6 //0.618
    property int unitsLabel2X_fullView: fullViewWidth * 0.28//0.25 //0.618
    property int unitsLabelY_fullView: fullViewWidth * 0.0296//0.02//0.031
    ...
    transitions: [
        Transition {
            to: "fullView"
            NumberAnimation { target: inputForm; property: "initialSliderValue"; to: slider.value}
            PropertyAnimation { target: inputForm; property: "z"; to: 1}
//          PropertyAnimation { target: fullControlButton; property: "visible"; to: false}
            ...
            ParallelAnimation{
                ...
                NumberAnimation{ target: inputForm; property: "x"; to: fullViewX; duration: enlargeTime}
                NumberAnimation { target: inputForm; property: "y"; to: fullViewY; duration: enlargeTime}
                ...
                PropertyAnimation { target: magnitudeLabel3; property: "y"; to: magnitudeLabel2Y_fullView; duration: enlargeTime}
                ...
                PropertyAnimation { target: magnitudeLabel2; property: "y"; to: magnitudeLabel2Y_fullView; duration: enlargeTime}
                ...
                PropertyAnimation { target: inputForm; property: "width"; to: fullViewWidth; duration: enlargeTime}
                PropertyAnimation { target: inputForm; property: "height"; to: fullViewHeight; duration: enlargeTime;}
            }
        },
        Transition {
            to: "reducedView"
            ...
            ParallelAnimation{
                ...
                PropertyAnimation { target: inputForm; property: "x"; to: initialX; duration: shrinkTime}
                PropertyAnimation { target: inputForm; property: "y"; to: initialY; duration: shrinkTime}
                ...
                PropertyAnimation { target: inputForm; property: "width"; to: initialWidth_reducedView; duration: shrinkTime}
                PropertyAnimation { target: inputForm; property: "height"; to: initialheight_reducedView; duration: shrinkTime}
...
//          PropertyAnimation { target: fullControlButton; property: "visible"; to: true}
            PropertyAnimation { target: inputForm; property: "z"; to: 0}
        }
    ]
    ...
    function init(){
        //slider.value = 16
        slider.value = Settings.get(saveStamp,slider.value)
        inputForm.inspected = false
        inputForm.state = startState
        inputForm.fullControlButton.visible = false
    }
    ...
    Component.onCompleted: {
        ...
        initialX = inputForm.x
        initialY = inputForm.y

        fullViewHeight = fullViewWidth * 0.82//0.88 // 0.47

        mainImageWith_reducedView = inputForm.width * 0.4
        mainImageMargin_reducedView = inputForm.width * 0.012

        magnitudeLabelFontSize_reducedView = inputForm.width * 0.28
        magnitudeLabelFontSize2_reducedView = inputForm.width * 0.15
        magnitudeLabelWidth_reducedView = inputForm.width * 0.95
        magnitudeLabelHeigtht_reducedView = inputForm.width * 0.28
        magnitudeLabelX_reducedView = inputForm.width * 0.03
        magnitudeLabelY_reducedView = inputForm.width * 0.43

        unitsLabelFontSize_reducedView = inputForm.width * 0.12
        unitsLabelWidth_reducedView = inputForm.width * 0.4
        unitsLabelHeigtht_reducedView = inputForm.width * 0.02
        unitsLabelX_reducedView = inputForm.width * 0.54
        unitsLabelY_reducedView = inputForm.width * 0.09
        unitsLabel2Y_reducedView = inputForm.width * 0.25

        initialWidth_reducedView = inputForm.width
        initialheight_reducedView = inputForm.width * 0.72
        inputForm.height = initialheight_reducedView
        inputForm.state = startState
    ...
    Slider {
        ...
        anchors.bottomMargin: sliderDownMargin
    ...
    Rectangle {
        ...
        anchors.bottom: parent.bottom
        anchors.bottomMargin: fixDownButtonMargin
    ...
    Rectangle {
        ...
        Button{
            ...
            opacity: 0
            anchors.fill: parent
            onClicked:{ inputForm.state = "reducedView"; inputForm.inspected = true; inputForm.verificado(); }
        }
    }
    ...
    Rectangle {
        ...
        Button{
            ...
            onClicked: {
                ...
                inputForm.state = "reducedView"
                inputForm.inspected = true
                inputForm.verificado()
            }
        }
    }
    ...
    Rectangle {
        ...
        Button{
            ...
            onClicked: {
                ...
                Settings.set(saveStamp, slider.value)
            }
        }
    }
...
/*
    Label {
        ...
        color: "#FFFFFF"
        text: magnitudeValue.toLocaleString().replace(",", ".")
        width: magnitudeLabelWidth_fullView
        height: magnitudeLabelHeigtht_fullView

        verticalAlignment: Text.AlignVCenter
        horizontalAlignment: Text.AlignHCenter
        font.pixelSize: magnitudeLabelFontSize_fullView

        anchors.bottom: downButton.bottom
        anchors.horizontalCenter: parent.horizontalCenter
        Rectangle{
            color: "#00000000"
            border.color: "#e5dada"
            ...
            Button{
                ...
                anchors.fill: parent
                onClicked: {
                    console.log("x:",magnitudeLabelR.x)
                    console.log("y:",magnitudeLabelR.y)
                }
            }
        }
    }
...
//        y: unitsLabelY_reducedView
        horizontalAlignment: Text.AlignRight
        verticalAlignment: Text.AlignVCenter
        font.pixelSize:70// unitsLabelFontSize_fullView
        Rectangle{
            anchors.fill: parent
            color:"#00000000"
            border.color: "#ffffff"
            Button{
                anchors.fill: parent
                onClicked: {
                    console.log("x:",unitsLabelRR.x)
                    console.log("y:",unitsLabelRR.y)
                }
            }
    ...
    Label {
        ...
        states: [
            State {
                ...
                AnchorChanges { target: magnitudeLabelForSavingEffect; anchors.horizontalCenter: saveButton.horizontalCenter }
                AnchorChanges { target: magnitudeLabelForSavingEffect; anchors.verticalCenter: saveButton.verticalCenter }
            },
            State {
                name: "saved"
    ...
    Progress_00{
        ...
        transitions:[
            Transition {
                to: "viewProgress"
                SequentialAnimation{
                    PropertyAnimation { target: progressIndicator; property: "height"; to: 505; duration: 150}
                    ParallelAnimation{
                        PropertyAnimation { target: progressIndicator.progressLabel; property: "opacity"; to: 1; duration: 300}
                        PropertyAnimation { target: progressIndicator.progressTool; property: "opacity"; to: 1; duration: 300}
                    }
                }
            },
            Transition {
                to: "noViewProgress"
                ParallelAnimation{
                    PropertyAnimation { target: progressIndicator; property: "height"; to: 0; duration: 200}
                    PropertyAnimation { target: progressIndicator.progressLabel; property: "opacity"; to: 0; duration: 100}
                    PropertyAnimation { target: progressIndicator.progressTool; property: "opacity"; to: 0; duration: 100}
                }
            }
        ]
        width: parent.width
